const BookCTA = () => (
  <div className="p4">
    ...
    <p>
      <em>Foraging North America</em> is a 12-week crash course designed to arm you with a
      functional working knowledge of botany and taxonomy that you can take with you out onto the
      land to fast-track the ID process and boost your confidence when gathering wild foods for the
    ...
    <p>Food is everywhere—you just need to know what to look for!</p>
    <p>
      <a href="https://thegoodliferevival.com/shop/fna">
