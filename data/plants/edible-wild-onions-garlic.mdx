...
date: '2020-02-04'
updated: '2022-07-20'
tags: ['botany', 'foraging', 'Amarylidaceae', 'Allium', 'greens', 'bulbs', 'flowers']
...
_Allium_ is the only genus in the Allieae tribe within the Allioideae subfamily, which should tell you that they are kind of in a league of their own. There are over 500 species in this genus.
...
Many, many other species are found locally and regionally throughout the continent: the [California Native Plant Society](<https://calscape.org/loc-california/Allium(all)>) lists 70 species found in that state alone! Thankfully, they are share a few unmistakable common traits which will be exemplified in the species covered here.
